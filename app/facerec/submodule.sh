...
m_repo=https://github.com/yeyupiaoling/PaddlePaddle-MobileFaceNets.git

if [ $action == "push" ]; then
    # 子模块
    # subtree_push data $m_repo master

    # submodule
    submodule_push MobileFaceNet $m_repo master
    ...
    # 子模块
    # subtree_pull data $m_repo master

    # submodule
    submodule_pull MobileFaceNet $m_repo master
